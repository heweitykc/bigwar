...
•	EchoCoreManager was renamed to _EchoCoreManager
•   Many shaders have been renamed
•   You now need to set light options on _EchoCoreManager and press compile button for lit shaders to work.
•   Spaceship shader was removed, light-25-lightmapped should be used in its place.
•   Flashlight shader was removed, use the new spotlight option on main directinal light.
